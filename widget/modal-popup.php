...
class CSWeding_modal_popup extends Widget_Base
{
    public function get_name()
    {
        return 'CSWeding_modal_popup';
    }
    public function get_title()
    {
        return __('CSWD Modal Popup');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'label' => esc_html__('Upload Foto Pempelai', 'elkit'),
        ...
        $this->add_control(
            'exit_animation',
            [
                'label' => __('Exit Animation', 'plugin-domain'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Exit Animation Duration', 'plugin-domain') . '(sec)',
        ...
        //         'default' => '#000',
        //         'selectors' => [
        //             '{{WRAPPER}} .overlayy' => 'background-color: {{VALUE}};',
        //         ],
        //     ]
        // );
...
?>
        ...
        <div class="modalx animated <?= $settings['entrance_animation'] ?>" data-sampul='<?php echo esc_url($image_link); ?>'>
            ...
            <div class="content-modalx">
                <div class="info_modalx">
                    ...
                    <?php if ($settings['text']) : ?>
                        <div class="wdp-text" <?php $this->print_render_attribute_string('text'); ?>><?php echo $settings['text']; ?></div>
                    <?php endif; ?>
        ...
        <script>
            ...
            jQuery('.wdp-button-wrapper button').on('click', function() {
                <?php
                if (empty($settings['exit_animation']) || $settings['exit_animation'] == null || $settings['exit_animation'] == '') {
                ?>
                    jQuery('.modalx').addClass('removeModals');
                <?php
                } else {
                ?>
                    jQuery('.modalx').removeClass('<?= $settings['entrance_animation'] ?>');
                    jQuery('.modalx').addClass('<?= $settings['exit_animation'] ?> reverse');
                <?php } ?>
